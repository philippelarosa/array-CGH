...
/*
 *
 * BreakpointFrequencyDisplayOP.java
 *
...
class BreakpointFrequencyDisplayOP extends GraphElementListOperation {
   
    static final String NAME = "Breakpoint Frequency Display";
	...
	for (int n = 0; n < size; n++)
	    if (getBreakpointFrequencyDisplay((GraphElement)graphElements.get(n)) == null)
		return false;

	return true;
    }

    Vector getBreakpointFrequencyDisplay(GraphElement graphElement) {
	...
	try {	
		...
		addAll(rGraphElements, getBreakpointFrequencyDisplay(graphElement));
	    }
