...
class DendrogramAxisDisplayer extends AxisDisplayer {

    DendrogramAxisDisplayer() {
	super("Dendrogram", DendrogramIDBuilder.getInstance());
    }
	...
	g.drawLine((int)minRX, h2, (int)maxRX, h2);
